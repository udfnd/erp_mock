...
export const linkName = style([typography.bodyB, { color: themeVars.palette.black }]);

export const linkAlias = style([typography.captionR, { color: themeVars.palette.cgrey500 }]);
...
export const sidePanel = {
  ...
  linkPreviewFallback: style([typography.bodyB, { color: themeVars.palette.cgrey500 }]),
  linkActions: style({
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
