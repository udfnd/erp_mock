...
import { LabeledInput, Button, IconButton, Textfield } from '@/common/components';
import { Delete, Plus, Edit } from '@/common/icons';
...
export default function GigwanSettingServicePage() {
  ...
  const handleAddWorkTypeStatus = useCallback(() => {
    ...
    dispatchWorkType({
      type: 'add',
      status: { nanoId: null, name: '', localId: local, isHwalseong: true, isNew: true },
    });
  }, []);
        ...
        <div css={styles.cardBody}>
          ...
          <div css={styles.cardFooter}>
            {basicState.nameFeedback && (
              <span css={styles.feedback[basicState.nameFeedback.type]}>
          ...
          <div css={styles.cardFooter}>
            {basicState.introFeedback && (
              <span css={styles.feedback[basicState.introFeedback.type]}>
